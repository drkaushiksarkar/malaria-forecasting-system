"""Configuration for graph_traversal subsystem."""
import os
...
class GraphTraversalConfig:
    """Configuration parameters for graph_traversal."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "GRAPH_TRAVERSAL") -> "GraphTraversalConfig":
        return cls(
