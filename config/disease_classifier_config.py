"""Configuration for disease_classifier subsystem."""
import os
...
class DiseaseClassifierConfig:
    """Configuration parameters for disease_classifier."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "DISEASE_CLASSIFIER") -> "DiseaseClassifierConfig":
        return cls(
