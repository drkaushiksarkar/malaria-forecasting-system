"""Configuration for forecast_engine subsystem."""
import os
...
class ForecastEngineConfig:
    """Configuration parameters for forecast_engine."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "FORECAST_ENGINE") -> "ForecastEngineConfig":
        return cls(
