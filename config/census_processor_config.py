"""Configuration for census_processor subsystem."""
import os
...
@dataclass
class CensusProcessorConfig:
    """Configuration parameters for census_processor."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "CENSUS_PROCESSOR") -> "CensusProcessorConfig":
        return cls(
