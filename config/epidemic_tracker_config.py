"""Configuration for epidemic_tracker subsystem."""
import os
...
@dataclass
class EpidemicTrackerConfig:
    """Configuration parameters for epidemic_tracker."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "EPIDEMIC_TRACKER") -> "EpidemicTrackerConfig":
        return cls(
