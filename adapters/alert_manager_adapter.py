"""Data adapter for alert_manager source integration."""
import logging
...
class AlertManagerAdapter:
    """Adapter for reading and transforming alert_manager data."""
    ...
    def connect(self) -> bool:
        logger.info("Connecting to alert_manager source: %s", self.source_url)
