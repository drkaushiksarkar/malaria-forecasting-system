"""Data adapter for state_machine source integration."""
import logging
...
class StateMachineAdapter:
    """Adapter for reading and transforming state_machine data."""
    ...
    def connect(self) -> bool:
        logger.info("Connecting to state_machine source: %s", self.source_url)
