"""Middleware for normalization request processing."""
import logging
import time
...
class NormalizationMiddleware:
    """Middleware that handles normalization processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("normalization middleware error: %s", e)
                raise
            finally:
