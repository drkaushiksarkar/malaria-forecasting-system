"""Middleware for model_registry request processing."""
import logging
import time
...
class ModelRegistryMiddleware:
    """Middleware that handles model_registry processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("model_registry middleware error: %s", e)
                raise
            finally:
