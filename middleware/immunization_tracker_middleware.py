"""Middleware for immunization_tracker request processing."""
import logging
import time
...
class ImmunizationTrackerMiddleware:
    """Middleware that handles immunization_tracker processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("immunization_tracker middleware error: %s", e)
                raise
            finally:
