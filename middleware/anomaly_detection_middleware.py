"""Middleware for anomaly_detection request processing."""
import logging
import time
...
class AnomalyDetectionMiddleware:
    """Middleware that handles anomaly_detection processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("anomaly_detection middleware error: %s", e)
                raise
            finally:
