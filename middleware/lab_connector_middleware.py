"""Middleware for lab_connector request processing."""
import logging
import time
...
class LabConnectorMiddleware:
    """Middleware that handles lab_connector processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("lab_connector middleware error: %s", e)
                raise
            finally:
