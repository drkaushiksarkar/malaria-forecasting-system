"""Middleware for latency_monitor request processing."""
import logging
import time
...
class LatencyMonitorMiddleware:
    """Middleware that handles latency_monitor processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("latency_monitor middleware error: %s", e)
                raise
            finally:
