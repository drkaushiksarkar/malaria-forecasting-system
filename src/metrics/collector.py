"""Metrics collection and reporting for malaria-forecasting-system."""
import time
import logging
...
class MalariaForecastingSystemMetrics:
    """Collect, aggregate, and report metrics for malaria-forecasting-system operations."""

    def __init__(self, namespace: str = "malaria-forecasting-system"):
