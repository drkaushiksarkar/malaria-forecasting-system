"""Utility helper for url_resolver operations."""
import logging
...
class UrlResolverHelper:
    """Helper class for url_resolver processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing url_resolver helper")
