"""Utility helper for namespace_resolver operations."""
import logging
...
class NamespaceResolverHelper:
    """Helper class for namespace_resolver processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing namespace_resolver helper")
