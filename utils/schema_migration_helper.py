"""Utility helper for schema_migration operations."""
import logging
...
class SchemaMigrationHelper:
    """Helper class for schema_migration processing."""
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing schema_migration helper")
