"""Service layer for health_indicator operations."""
import logging
...
class HealthIndicatorService:
    """Service for health_indicator domain operations."""
    ...
    async def fetch(self, query: Dict[str, Any]) -> HealthIndicatorResult:
        ...
        try:
            ...
            return HealthIndicatorResult(success=True, data=data, duration_ms=duration)
        except Exception as e:
            logger.error("Fetch failed: %s", e)
            return HealthIndicatorResult(success=False, error=str(e))
